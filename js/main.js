...
function showtask(){
    ...
    taskObj.forEach((item, index) => {
        ...
        html += `<tr class="table-rows">
                    ...
                    ${taskCompleteValue}
                    <td><button type="button" onclick="edittask(${index})" class="button-action edit-btn"><i class="fa fa-edit"></i><span class="button-action">Edit</span></button></td>
                    <td><button type="button" class="text-success-complete" id=${index}><i class="fa fa-check-square-o"></i><span class=" text-success-complete">Complete</span></button></td>
                    <td><button type="button" onclick="deleteitem(${index})" class="delete-btn"><i class="fa fa-trash"></i><span class="button-action">Delete</span></button></td>
                </tr>`;
    });
...
let addedtasklist = document.getElementById("addedtasklist");
    addedtasklist.addEventListener("click", function(e){
       // console.log(e);
        ...
        if(mytarget.classList[0] === 'text-success-complete'){
